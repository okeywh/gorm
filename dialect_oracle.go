...
func init() {
	RegisterDialect("godror", &oracle{})
	//fmt.Println("oralce is init！")
}
...
/* func (s oracle) LastInsertIDReturningSuffix(tableName, key string) string {
